...
import profilePhoto from "../../assets/images/vivek.png";
...
const Hero = () => {
  ...
  return (
    <section className="w-full cursor-default bg-[#855ff6] xl:px-44 lg:px-40 sm:pt-48 sm:pb-0 pt-28 md:px-32 sm:px-28 vvs:px-12 px-10">
