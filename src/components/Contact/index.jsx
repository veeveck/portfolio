    ...
    >
      <div className="text">
        ...
        <p className="text-white/50  cursor-default font-Glimer-Light sm:mt-10 mt-8 xl:text-xl xl:max-w-2xl text-base sm:text-lg  1/2xl:text-2xl 1/2xl:max-w-4xl 2xl:text-3xl 2xl:max-w-5xl leading-6">
          I'm active on{" "}
          <a
            href="https://www.linkedin.com/in/vivek-saini-718b63141/"
            target="_blank"
            className="text-white font-Glimer-Medium"
          >
            Linkedin
          </a>{" "}
          but you can contact me also via mail{" "}
          <a
            href="viveksainicu@gmail.com"
            target="_blank"
            className="text-white font-Glimer-Medium"
          >
            Gmail
      ...
      <div className="flex flex-col py-2 mb-5 w-full space-y-6 items-center justify-center">
        <div className="divide-x divide-solid divide-white/50 grid grid-cols-3 w-full">
          ...
          >
            <AiOutlineLinkedin className="social-icon h-7 w-7 sm:h-8 sm:w-8 xl:h-9 xl:w-9 2xl:h-10 2xl:w-10" />
          </a>
          <a
            href="https://github.com/veeveck"
            target="_blank"
            className="flex items-center justify-center flex-col text-lg text-white"
          >
          ...
          <a
            href="mailto:viveksainicu@gmail.com"
            target="_blank"
            className="flex items-center justify-center flex-col text-lg text-white"
          >
            <FiMail className="social-icon h-7 w-7 sm:h-8 sm:w-8 xl:h-9 xl:w-9 2xl:h-10 2xl:w-10" />
          </a>
        </div>
      </div>
    </div>
